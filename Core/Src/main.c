...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, ROW1_Pin|ROW0_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : COL5_Pin COL9_Pin COL8_Pin COL7_Pin
                           COL6_Pin */
  GPIO_InitStruct.Pin = COL5_Pin|COL9_Pin|COL8_Pin|COL7_Pin
                          |COL6_Pin;
